...
public class Teams extends FootballApiHeaders {

    @Autowired
    private RestTemplate restTemplate;

    @Autowired
    private FootballApiHeaders apiHeaders;

    @GetMapping("/teams/all")
    public ResponseEntity<?> getAllTeams(@RequestParam(value = "league") Integer leagueId, @RequestParam(value="season") Integer season) throws JsonProcessingException {
        String url = apiHeaders.resourceURL + "/teams?league={queryLeague}&season={querySeason}";
